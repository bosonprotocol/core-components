...
import type {
  BiconomyForwarder,
  BiconomyForwarderInterface,
} from "../BiconomyForwarder";
...
export class BiconomyForwarder__factory {
  static readonly abi = _abi;
  static createInterface(): BiconomyForwarderInterface {
    return new utils.Interface(_abi) as BiconomyForwarderInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BiconomyForwarder {
    return new Contract(address, _abi, signerOrProvider) as BiconomyForwarder;
  }
}
