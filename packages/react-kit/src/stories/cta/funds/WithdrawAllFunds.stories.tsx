...
import { WithdrawAllFundsButton } from "../../../components/cta/funds/WithdrawAllFundsButton";

import { hooks } from "../../helpers/connect-wallet";
import { CtaButtonWrapper } from "../../helpers/CtaButtonWrapper";

export default {
  title: "Visual Components/CTA/funds/WithdrawAllFundsButton",
  component: WithdrawAllFundsButton
...
export const Simple: ComponentStory<typeof WithdrawAllFundsButton> =
  Template.bind({});
export const WithStep: ComponentStory<typeof WithdrawAllFundsButton> =
  Template.bind({});
export const WithMetaTx: ComponentStory<typeof WithdrawAllFundsButton> =
  Template.bind({});
